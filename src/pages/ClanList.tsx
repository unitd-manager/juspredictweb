...
import { CreateClanDialog } from '../components/clanDyn/CreateClanDialog';
import { groupApi, type GroupSummary } from '../api/groupDyn';
    ...
    return (
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {filteredGroups.map((group) => {
          ...
          const destination = groupId ? `/clanDetailDyn/${groupId}` : "#";
