...
export const PageHeader: React.FC<PageHeaderProps> = ({
  ...
  const paddingClasses = compact
    ? "relative pt-8 pb-4 overflow-hidden px-4 sm:px-6 lg:px-8 mb-6"
    : "relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden px-4 sm:px-6 lg:px-8";

  const headingClasses = compact
    ? 'text-2xl md:text-3xl lg:text-4xl font-bold mx-auto mb-4'
    : 'text-6xl lg:text-7xl font-bold mx-auto mb-6';

  const taglineClasses = compact
    ? 'text-sm text-gray-text mb-4 mx-auto max-w-2xl leading-normal'
    : 'text-xl text-gray-text mb-10 mx-auto max-w-2xl leading-relaxed';
  ...
  return (
    <section className={paddingClasses}>
      ...
      <div className="max-w-[1400px] mx-auto relative z-10 text-center">
        {/* Heading and Tagline */}
        <h1 className={`${headingClasses} ${isSubpage ? 'pt-4' : ''}`}>
